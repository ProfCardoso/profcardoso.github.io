...
Lien vers le site officiel :  <a href="pillow.readthedocs.io/en/stable/" target="_blank_" >pillow.readthedocs.io/en/stable/</a>
...
Comme pour toute librairie, pour pouvoir l'utiliser, il faut qu'elle soit installée dans l'environnement d'exécution de python utilisé. C'est le cas avec Thonny (version xxl).
